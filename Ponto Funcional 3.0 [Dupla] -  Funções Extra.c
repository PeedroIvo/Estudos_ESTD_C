...
Lista Duplamente Encadeada com funções de Busca, Inserção no Início e Inserção no Meio
*/
...
main()
{
    ...
    while(opcao == 0)
    {
        ...
        printf("4 - Deletar um ponto\n");
        printf("5 - Buscar um ponto\n");
        printf("6 - Imprimir a lista de ponto\n");
        printf("7 - Sair\n\n");
        scanf("%d", &opcao);
